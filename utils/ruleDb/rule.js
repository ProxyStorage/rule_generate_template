...
function getRuleList(platform = 'surge') {
  return {
    ...
    globalApp: [
      ...
      {
        files: {
          domain: generateRuleUrl('teams', 'teams_domain', platform),
          noIp: generateRuleUrl('teams', 'teams_no_ip_rule', platform),
          ip: generateRuleUrl('teams', 'teams_ip_rule', platform),
          asn: generateRuleUrl('teams', 'teams_ip_asn_rule', platform),
        },
        proxyName: proxyName.Teams,
      },
      {
        files: {
