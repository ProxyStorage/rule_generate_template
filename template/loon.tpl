...
{{ customParams.proxyName.Notion }} = select,{{ customParams.proxyName.Direct }},{{ customParams.proxyName.Proxy }},{{ customParams.allSelect }},{{ customParams.allIncludeGroup }},img-url = https://raw.githubusercontent.com/fmz200/wool_scripts/main/icons/softlyx/PikPak.png
...
{{ customParams.proxyName.Performance }} = select,{{ customParams.proxyName.Reject }},{{ customParams.proxyName.Emby }},{{ customParams.proxyName.Proxy }},{{ customParams.allSelect }},{{ customParams.allIncludeGroup }},img-url = https://raw.githubusercontent.com/fmz200/wool_scripts/main/icons/erdongchanyo/Pornhub.png
...
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Notion/Notion.list, policy={{ customParams.proxyName.Notion }}, tag=Notion, parser-enable=true, enabled=true
# Google
...
# Porn
https://raw.githubusercontent.com/LM-Firefly/Rules/master/PROXY/Porn.list, policy={{ customParams.proxyName.Performance }}, tag=Porn, parser-enable=true, enabled=true
# Spotify规则
